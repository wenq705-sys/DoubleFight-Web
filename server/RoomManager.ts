...
export class RoomManager {
  ...
  private createRoom(connectionId: string, playerName: string, theme: NetworkThemeId, loadout: SkillLoadout): void {
    this.removeFromMatchmaking(connectionId, true);
    this.leaveRoom(connectionId);
  ...
  private joinRoom(connectionId: string, roomCode: string, playerName: string, theme: NetworkThemeId, loadout: SkillLoadout): void {
    this.removeFromMatchmaking(connectionId, true);
    this.leaveRoom(connectionId);
